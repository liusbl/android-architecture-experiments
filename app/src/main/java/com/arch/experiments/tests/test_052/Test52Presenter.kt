...
import com.arch.experiments.tests.test_052.lib_core.Machine
import com.arch.experiments.tests.test_052.lib_core.Observer
import com.arch.experiments.tests.test_052.lib_core.Pusher

class Test52Presenter {
    fun start(
