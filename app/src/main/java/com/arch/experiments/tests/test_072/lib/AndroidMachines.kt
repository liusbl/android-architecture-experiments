...
interface AndroidMachines {
    ...
    fun Context.createToastPusher(): Supplier<String> {
        return getToastConfig().createSupplier("")
    }
    ...
    fun <State> Config<State>.createSupplier(initialState: State): Supplier<State> {
