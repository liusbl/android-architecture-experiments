...
import com.arch.experiments.tests.test_054.lib_core.Machine
import com.arch.experiments.tests.test_054.lib_core.Observer
import com.arch.experiments.tests.test_054.lib_core.Pusher

class Test54Presenter {
    fun start(
