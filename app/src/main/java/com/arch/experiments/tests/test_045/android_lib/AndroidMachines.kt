...
import com.arch.experiments.tests.test_045.core_lib.GlobalMachine
...
//        createUnsafeMachine<String>(initialState, {
//                editText.setSafeText(value)
//            }, {
//                editText.onTextChanged { text -> it(text) }
//            })
    }
