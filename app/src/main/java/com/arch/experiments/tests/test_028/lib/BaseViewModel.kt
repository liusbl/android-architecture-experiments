...
abstract class BaseViewModel<State : Any, StateUpdate : Any, Action : Any, Effect>(
    ...
    protected abstract fun onStateChange(stateUpdate: StateUpdate): State
    ...
    fun postStateUpdate(stateUpdate: StateUpdate) {
//        onAction(action)
//            .subscribe(stateStream::onNext, unhandledErrorStream::onNext)
//            .addTo(disposables)
    }
