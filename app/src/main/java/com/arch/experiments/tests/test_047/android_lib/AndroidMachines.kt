package com.arch.experiments.tests.test_047.android_lib
...
import com.arch.experiments.tests.test_047.core_lib.GlobalMachine
...
fun createToastMachine(
    ...
    observe { context.showToast(value) }
}
